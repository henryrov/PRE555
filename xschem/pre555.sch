...
N 220 -20 250 -20 {lab=OUTPUT}
N 220 20 250 20 {lab=#net4}
N 250 20 250 70 {lab=#net4}
N 180 120 220 120 {lab=GND}
N 280 120 290 120 {lab=DISCHARGE}
N 290 120 310 120 {lab=DISCHARGE}
...
N 250 70 250 80 {lab=#net4}
N 130 100 130 110 {lab=RESET}
N 130 20 130 30 {lab=#net5}
...
C {gnd.sym} 180 120 0 0 {name=l1 lab=GND}
C {iopin.sym} 310 120 0 0 {name=p2 lab=DISCHARGE}
